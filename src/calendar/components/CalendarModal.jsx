...
export const CalendarModal = () => {
	...
	const onSubmit = async (event) => {
		...
		if (difference <= 0) {
			Swal.fire(
				'Debes poner una fecha de finalizacion posterior a la de inicio',
		...
		if (formValue.title.length <= 0) {
			Swal.fire(
				'Debes escribir un titulo para tu fecha',
				'Revisar el titulo',
				'error'
			)
			return
		...
		// 	Swal.fire('Usted no esta autorizado para modificar este evento', 'Todo 👎', 'error')
		// 	return 
		// }
